...
public:
	...
	*/
	...
	void read()
	{
		...
		// Debug output
		FlowSerialDebugPrintLn("Data received: Speed=" + speed + " Gear=" + gear + " RPM=" + String(rpmPercent));
	}
	...
	void loop()
	{
		...
		// Third Column (speed)
		//drawCell(COL[1], ROW[0], speed, "speed", "Speed");
		drawCell(COL[1], ROW[0], speed, "speed", "Speed", "center", TFT_WHITE, 6);
